# spinWannier
**<i>Tools for handling Wannier models with a spin operator, calculating the Wannier model quality and spin-texture plotting. See the [documentation](https://liborsold.github.io/spinWannier/).</i>**
