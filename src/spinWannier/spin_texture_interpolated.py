...
from wannier_utils import check_file_exists, get_kpoint_names, eigenval_dict, load_dict, load_lattice_vectors, \
                            ...
                            unite_spn_dict, plot_bands_spin_texture
...
kmesh_density_1D = 101
kmesh_density_2D = 501
...
def plot_bands_spin_texture(kpoints, kpath, Eigs_k, S_mn_k_H_x, S_mn_k_H_y, S_mn_k_H_z, EF=0, fout='spin_texture_1D_home_made.jpg', fig_caption="home-made interpolation", ticks=None, tick_labels=None, yaxis_lim=yaxis_lim):
...
def procedure(kmesh_density=100, kmesh_2D=False):
    ...
    # !!! actually K-point should be (0.33, 0.33, 0) not (0.67, -0.33, 0) !!
    kpoint_matrix = [
